...
global.owner = process.env.OWNER_NUMBER  || '94724800886' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=LYtyzSSL#sYTsrtfbbRHo_fZQ6hohSf-5Vzv6W9XiBWKcQS3P1lQ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94724800886" : process.env.MODERATORS ,    
